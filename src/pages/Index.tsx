...
const directions = [
  ...
  { num: "02", title: "Воздушное кольцо", desc: "Элегантные позы, вращения и поддержки в воздухе. Берём с 4 лет.", icon: "Circle" },
...
const stats = [
  ...
  { num: "от 4", label: "лет — начинаем с детей" },
];
    ...
    <>
      ...
      <section className="relative min-h-[calc(100vh-4rem)] flex items-center overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-12 items-center py-20">
          <div className="relative z-10">
            ...
            <h1 className="font-display text-6xl md:text-7xl lg:text-8xl font-light leading-[0.95] mb-8 animate-fade-up animation-delay-200">
              Студия<br />
              <span className="shimmer-text font-semibold">Flexiя</span>
            </h1>
            <p className="text-[#8c6478] text-lg max-w-md mb-10 leading-relaxed font-body font-light animate-fade-up animation-delay-400">
              Pole sport, воздушное кольцо, акробатика и полотна. Для детей от 4 лет и взрослых с любым уровнем подготовки.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {directions.map(({ num, title, desc, icon }, i) => (
              <div
                key={num}
                className="reveal group bg-white border border-pink-100 rounded-2xl p-7 hover:border-pink-300 hover:shadow-xl hover:shadow-pink-100 transition-all duration-300"
            ...
            <div className="absolute inset-0 flex items-center px-12 md:px-20">
              <div className="text-white max-w-lg">
                ...
                <p className="text-pink-100 text-sm leading-relaxed font-body font-light max-w-sm">
                  Две профессионально оборудованные студии в Перми. Просторные залы, современное оборудование и тёплая атмосфера.
                </p>
                <Link
                  to="/branches"
                  className="inline-flex items-center gap-2 mt-6 text-sm text-white border border-white/40 px-5 py-2.5 rounded-full hover:bg-white/10 transition-all"
                >
                  Наши филиалы <Icon name="ArrowRight" size={14} />
                </Link>
              </div>
            </div>
          </div>
      ...
      <section className="py-28 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative inline-block reveal w-full">
            ...
            <div className="relative bg-gradient-to-br from-pink-400 to-rose-400 rounded-[2.5rem] px-12 py-16 shadow-2xl shadow-pink-200">
              <p className="text-xs font-medium tracking-widest text-pink-100 uppercase mb-6 font-body">Начни прямо сейчас</p>
